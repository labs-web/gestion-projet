...
- [Rappel Markdown](#rappel-markdown)
  ...
  - [Tables](#tables)
  - [Checkbox](#checkbox)
- [Présentation de solicode en Markdown](#résentation-de-solicode-en-markdown)
  - [Livrables](#livrables)
- [Taille d’image](#taille-dimage)
  - [Luna Paint — Image Editor](#luna-paint--image-editor)
  - [Example d’image en utilisant kramdown](#example-dimage-en-utilisant-kramdown)
  - [Références](#références)
- [Rapport markdown](#rapport-markdown)
  - [Introduction](#introduction)
  - [Syntaxe de base pour l’écriture et la mise en forme](#syntaxe-de-base-pour-lécriture-et-la-mise-en-forme)
